...
if __name__ == '__main__':
    ...
    if is_2D:
        dataset = FloqLindDataset2D(path_test, size, suffix_test, function, transforms_regular)
    else:
        dataset = FloqLindDataset(path_test, size, suffix_test, function, transforms_regular)
